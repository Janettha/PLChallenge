...
@Composable
fun PreviewModernSegmentedControl() {
...
@Preview(showBackground = true)
@Composable
fun PreviewModernSegmentedControlWithThreeSegments() {
    val items = listOf("Day", "Week", "Month")
    var selectedIndex by remember { mutableIntStateOf(1) } // Middle segment selected
...
@Preview(showBackground = true)
@Composable
fun PreviewModernSegmentedControlWithFourSegments() {
        ...
        Surface(modifier = Modifier.padding(16.dp)) {
            ModernSegmentedControl(
                ...
                colors = SegmentedControlColors(
                    containerBackground = Color(0xFFEFF6FF),
                    selectedBackground = Color(0xFF0891B2),
                    selectedTextColor = Color.White,
                    unselectedTextColor = Color(0xFF475569),
                    separatorColor = Color(0xFFBFDBFE)
                )
            )
        }
    }
